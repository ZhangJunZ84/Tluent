return {
	...
	ElementBorder = Color3.fromRGB(38, 38, 44), -- More visible card border
	InElementBorder = Color3.fromRGB(50, 50, 58),
	ElementTransparency = 0.93, -- Frosted but visible
	...
	SidebarBackground = Color3.fromRGB(10, 10, 10), -- Same as AcrylicMain — matches TitleBar tone
	ContentBackground = Color3.fromRGB(18, 18, 22), -- Distinctly lighter than sidebar

	SecondaryContainer = Color3.fromRGB(18, 22, 32), -- Deepest dark blue for selected tab
